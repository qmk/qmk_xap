...
pub mod xap {
    ...
    #[derive(
        BinRead, PartialEq, Eq, PartialOrd, Ord, Hash, Debug, Clone, Copy, Serialize,
    )]
...
pub mod keymap {
    ...
    #[derive(BinWrite, Default, Debug, Clone, Serialize, Deserialize)]
...
pub mod types {
    ...
    #[derive(BinRead, BinWrite, Default, Debug, Clone, Serialize, Deserialize)]
