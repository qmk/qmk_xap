...
export const commands = {
    async xapVersion(id: string): Promise<Result<XapVersionResponse, FrontendError>> {
        try {
    ...
    async xapCapabilities(id: string): Promise<Result<XapCapabilitiesFlags, FrontendError>> {
        try {
    ...
    async xapEnabledSubsystemCapabilities(
        id: string,
    ): Promise<Result<XapEnabledSubsystemCapabilitiesFlags, FrontendError>> {
        try {
            return {
                status: 'ok',
    ...
    async xapSecureStatus(id: string): Promise<Result<XapSecureStatusResponse, FrontendError>> {
        try {
    ...
    async xapSecureUnlock(id: string): Promise<Result<null, FrontendError>> {
        try {
    ...
    async xapSecureLock(id: string): Promise<Result<null, FrontendError>> {
        try {
    ...
    async qmkVersion(id: string): Promise<Result<QmkVersionResponse, FrontendError>> {
        try {
    ...
    async qmkCapabilities(id: string): Promise<Result<QmkCapabilitiesFlags, FrontendError>> {
        try {
    ...
    async qmkBoardIdentifiers(
        id: string,
    ): Promise<Result<QmkBoardIdentifiersResponse, FrontendError>> {
        try {
    ...
    async qmkBoardManufacturer(
        id: string,
    ): Promise<Result<QmkBoardManufacturerResponse, FrontendError>> {
        try {
    ...
    async qmkProductName(id: string): Promise<Result<QmkProductNameResponse, FrontendError>> {
        try {
    ...
    async qmkConfigBlobLength(
        id: string,
    ): Promise<Result<QmkConfigBlobLengthResponse, FrontendError>> {
        try {
    ...
    async qmkConfigBlobChunk(
        id: string,
        arg: number,
    ): Promise<Result<QmkConfigBlobChunkResponse, FrontendError>> {
        try {
    ...
    async qmkJumpToBootloader(
        id: string,
    ): Promise<Result<QmkJumpToBootloaderResponse, FrontendError>> {
        try {
    ...
    async qmkHardwareIdentifier(
        id: string,
    ): Promise<Result<QmkHardwareIdentifierResponse, FrontendError>> {
        try {
    ...
    async qmkReinitializeEeprom(
        id: string,
    ): Promise<Result<QmkReinitializeEepromResponse, FrontendError>> {
        try {
    ...
    async keymapCapabilities(id: string): Promise<Result<KeymapCapabilitiesFlags, FrontendError>> {
        try {
    ...
    async keymapGetLayerCount(
        id: string,
    ): Promise<Result<KeymapGetLayerCountResponse, FrontendError>> {
        try {
    ...
    ): Promise<Result<KeymapGetKeycodeResponse, FrontendError>> {
        try {
    ...
    ): Promise<Result<KeymapGetEncoderKeycodeResponse, FrontendError>> {
        try {
            return {
                status: 'ok',
    ...
    async remappingCapabilities(
        id: string,
    ): Promise<Result<RemappingCapabilitiesFlags, FrontendError>> {
        try {
    ...
    async remappingGetLayerCount(
        id: string,
    ): Promise<Result<RemappingGetLayerCountResponse, FrontendError>> {
        try {
    ...
    async lightingCapabilities(
        id: string,
    ): Promise<Result<LightingCapabilitiesFlags, FrontendError>> {
        try {
    ...
    async backlightCapabilities(
        id: string,
    ): Promise<Result<BacklightCapabilitiesFlags, FrontendError>> {
        try {
    ...
    async backlightGetEnabledEffects(
        id: string,
    ): Promise<Result<BacklightGetEnabledEffectsResponse, FrontendError>> {
        try {
            return {
                status: 'ok',
    ...
    async backlightGetConfig(id: string): Promise<Result<BacklightConfig, FrontendError>> {
        try {
    ...
    async backlightSaveConfig(id: string): Promise<Result<null, FrontendError>> {
        try {
    ...
    async rgblightCapabilities(
        id: string,
    ): Promise<Result<RgblightCapabilitiesFlags, FrontendError>> {
        try {
    ...
    async rgblightGetEnabledEffects(
        id: string,
    ): Promise<Result<RgblightGetEnabledEffectsResponse, FrontendError>> {
        try {
            return {
                status: 'ok',
    ...
    async rgblightGetConfig(id: string): Promise<Result<RgbLightConfig, FrontendError>> {
        try {
    ...
    async rgblightSetConfig(id: string, arg: RgbLightConfig): Promise<Result<null, FrontendError>> {
        try {
    ...
    async rgblightSaveConfig(id: string): Promise<Result<null, FrontendError>> {
        try {
    ...
    async rgbmatrixCapabilities(
        id: string,
    ): Promise<Result<RgbmatrixCapabilitiesFlags, FrontendError>> {
        try {
    ...
    async rgbmatrixGetEnabledEffects(
        id: string,
    ): Promise<Result<RgbmatrixGetEnabledEffectsResponse, FrontendError>> {
        try {
            return {
                status: 'ok',
    ...
    async rgbmatrixGetConfig(id: string): Promise<Result<RgbMatrixConfig, FrontendError>> {
        try {
    ...
    async rgbmatrixSaveConfig(id: string): Promise<Result<null, FrontendError>> {
        try {
    ...
    async audioCapabilities(id: string): Promise<Result<AudioCapabilitiesFlags, FrontendError>> {
        try {
    ...
    async audioGetConfig(id: string): Promise<Result<AudioConfig, FrontendError>> {
        try {
    ...
    async audioSetConfig(id: string, arg: AudioConfig): Promise<Result<null, FrontendError>> {
        try {
    ...
    async audioSaveConfig(id: string): Promise<Result<null, FrontendError>> {
        try {
